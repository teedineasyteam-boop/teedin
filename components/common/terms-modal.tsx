  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="overflow-y-auto flex-1 text-base mb-6 pr-2 leading-relaxed text-gray-800 scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-blue-100"
          style={{
            scrollbarColor: "#60a5fa #e0e7ff", // thumb, track
            scrollbarWidth: "thin",
          }}
        >
          ...
          <p className="mb-2">
            ...
            use of the Products and Services, or your submission of ideas and/or
            related materials to us or from any person's use of any ID,
            membership or password you maintain with any portion of the Site,
          ...
          <p className="mb-2">
            ...
            from a location outside of the Ukraine, you are responsible for
          ...
          <p className="mb-2">
            ...
            scope or extent of such section. Our failure to act with respect to
            a breach by you or others does not waive our right to act with
            respect to subsequent or similar breaches. These Terms and
            Conditions set forth the entire understanding and agreement between
            us with respect to the subject matter contained herein and supersede
        ...
        <div className="flex justify-end gap-2 mt-4">
          <button
            className="bg-black text-white rounded px-4 py-2 transition-all duration-150 hover:scale-105 focus:scale-105"
            onClick={onClose}
          >
            ปิด
          </button>
          <button
            className="bg-blue-600 text-white rounded px-4 py-2 transition-all duration-150 hover:scale-105 focus:scale-105"
            onClick={onAccept}
          >
            ยอมรับ
          </button>
